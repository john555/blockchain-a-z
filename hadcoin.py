...
receiver = os.getenv('RECEIVER', 'John')

#Crearting an address for the node
...
def connect_node():
  ...
  response = {
    'message': 'All the nodes are connected. The Hadcoin Blockchain now contains the following nodes:',
